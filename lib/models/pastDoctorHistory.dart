...
PastDoctorHistory pastDoctorHistoryFromJson(String str) =>
    PastDoctorHistory.fromJson(json.decode(str));

String pastDoctorHistoryToJson(PastDoctorHistory data) =>
...
class PastDoctorHistory {
  ...
  factory PastDoctorHistory.fromJson(Map<String, dynamic> json) =>
      PastDoctorHistory(
        result: json["result"],
