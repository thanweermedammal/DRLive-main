...
class wallet extends StatefulWidget {
  wallet({Key key, this.is_base_category = false, this.is_top_category = false})
      : super(key: key);
...
class _walletState extends State<wallet> {
  ...
  Future<Docwallet> fetchAppointment;
  @override
  void initState() {
    super.initState();
    fetchAppointment = History().doctorWalletApi(doctor_id.$.toString());
  }
