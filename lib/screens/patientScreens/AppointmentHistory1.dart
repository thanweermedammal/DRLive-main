  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: () async {
            fetchAppointment =
                History().activePatientData(user_id.$.toString());
            pastPatientHistory = History()
                .pastPatientData(user_id.$.toString(), from, to, name.text);
          },
          child: WillPopScope(
            onWillPop: () async {
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(),
                              Text(snapshot
                                  .data.appointments[index].firstName.name
                                  .toString()
                                  .toUpperCase()),
                              SizedBox(),
                              Text(snapshot.data.appointments[index].method.name
                                  .toString()),
                              Text(snapshot
                                  .data.appointments[index].category.name.name
                                  .toString()),
                              Text(snapshot
                                  .data.appointments[index].paymentStatus.name
                                  .toString()),
                            ],
                          ),
                        ),
